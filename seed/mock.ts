...
// ----------------------------------------------------------------------------
// Studio Floor Today — what's happening physically inside IMS right now
// ----------------------------------------------------------------------------
export const mockStudioFloorToday = [
  {
    id: 'sf_1',
    clientName: 'Marcus Chen',
    status: 'in_session' as const,
    asset: 'Strength Floor — Rack 1',
    startedAt: '9:00 AM',
    endsAt: '10:00 AM',
  },
  {
